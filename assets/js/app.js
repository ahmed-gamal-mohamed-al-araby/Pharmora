...
const I18N = {
  ar: {
    ...
    'pr.compare': 'اختيار سريع:',
    'pr.inc1': 'التحديثات وتحسينات النظام ضمن الاشتراك',
    'pr.inc2': 'الدعم عبر واتساب وsupport@pharmora.com',

    'pr.guideTitle': 'الأساسية للبيع والمخزون. الاحترافية للتأمين والورديات. إدارة الفروع لفرعين أو أكتر.',
    'pr.guide1': 'أسعار الصيدلية الواحدة: ٨٠٠ أو ١٥٠٠ ج.م شهرياً',
    'pr.guide2': 'سعر إدارة الفروع يتحدد حسب العدد وطريقة التشغيل',
    'pr.guide3': 'كل نسخة تشمل إعداد الحساب ومساعدة نقل البيانات وتدريب الفريق',
    'pr.guideHint': 'لو طريقة شغلك بين نسختين، نحدد الأنسب معاك أثناء العرض التوضيحي.',
    ...
    'ab.whyEy': 'ليه بدأنا',
    'ab.whyT': 'المشكلة ما كانتش في نقص البرامج',
    'ab.whyS': 'المشكلة إن أجزاء الشغل ما بتكلمش بعض. فاتورة الشراء تدخل في مكان، والجرد يتعمل في ملف، ومطالبات التأمين تتراجع آخر الشهر على إكسيل. صاحب الصيدلية يلاقي نفسه بيراجع نفس الأرقام أكتر من مرة عشان يعرف الرصيد أو الربح.',
    'ab.c1t': 'البيع والجرد في مكانين',
    'ab.c1d': 'لما البيع ما يخصمش من التشغيلة الصح، رصيد البرنامج يختلف عن اللي على الرف. الفرق غالباً ما يظهرش غير وقت الجرد.',
    'ab.c2t': 'رقم المبيعات ناقص',
    'ab.c2d': 'إجمالي البيع ما يقولش تكلفة البضاعة، ولا المصروفات، ولا حصة التأمين اللي لسه ما اتحصلتش. التفاصيل دي هي اللي تحدد الهامش.',
    'ab.c3t': 'الصنف الواحد له أكتر من صلاحية',
    'ab.c3d': 'نفس الدواء ممكن يكون موجود في أكتر من تشغيلة. وقت الاستلام والبيع، الكمية وتاريخ الصلاحية لازم يفضلوا مربوطين ببعض.',
    'ab.c4t': 'التغطية بتختلف من دواء للتاني',
    'ab.c4d': 'شركة التأمين ممكن تغطي كل دواء بنسبة مختلفة. حصة المريض وحصة الشركة لازم يتحسبوا قبل ما المطالبة تدخل المتابعة.',
    'ab.c5t': 'مش كل مستخدم يشوف كل حاجة',
    'ab.c5d': 'الكاشير يبيع ويقفل ورديته. تعديل سعر أو رصيد مخزون يحتاج صلاحية منفصلة، وسجل المراجعة يحتفظ باسم اللي عمله.',
    'ab.c6t': 'Pharmora بيربط السجلات دي',
    'ab.c6d': 'فاتورة البيع تخصم من التشغيلة، تسجل طريقة الدفع، وتحسب حصة التأمين. بعدها تظهر نفس الحركة في المخزون والتقارير من غير إدخالها مرة تانية.',
    'ab.misEy': 'اللي بنشتغل عليه',
    'ab.misT': 'مراجعة يدوية أقل، من غير ما نخفي التفاصيل',
    'ab.misD': 'صاحب الصيدلية لازم يقدر يفتح رقم المبيعات أو المخزون ويرجع للحركات اللي عملته. عشان كده مصدر الرقم مهم عندنا بقدر الرقم نفسه.',
    'ab.visEy': 'قدّام',
    'ab.visT': 'نبدأ بما تحتاجه الصيدلية المصرية فعلاً',
    'ab.visD': 'الأولوية دلوقتي للبيع والمخزون والتأمين والحسابات اليومية داخل الصيدلية. ومع الفروع، نفس قواعد الأسعار والصلاحيات والتقارير لازم تفضل ثابتة من مكان لمكان.',
    'ab.philEy': 'قرارات المنتج',
    'ab.philT': 'كل شاشة تبدأ بسؤال من الشغل',
    'ab.philS': 'هل الصنف موجود؟ أنهي تشغيلة تتباع؟ مين غيّر السعر؟ المطالبة اتحصّلت ولا لسه؟ بنبدأ بالسؤال، وبعدها نبني الشاشة.',
    'ab.p1t': 'حساب الوحدات',
    'ab.p1d': 'سعر القرص لازم يرجع لسعر الشريط والعلبة صح، والتكلفة تفضل مرتبطة بالتشغيلة اللي اتباعت.',
    'ab.p2t': 'شاشة كل دور',
    'ab.p2d': 'الكاشير يحتاج البحث والبيع والدفع. إعدادات الأسعار والصلاحيات تفضل بعيد عن طريقه.',
    'ab.p3t': 'التعديلات المسجلة',
    'ab.p3d': 'كل تعديل حساس يتسجل باسم المستخدم ووقته، سواء كان في فاتورة أو سعر أو رصيد مخزون.',
    'ab.p4t': 'إقفال الوردية',
    'ab.p4d': 'حركة الدرج وطرق الدفع والمصروفات لازم تكون واضحة وقت تسليم الوردية، مش بعد نهاية الشهر.',
    'ab.p5t': 'التقارير',
    'ab.p5d': 'بنبدأ من الفاتورة وحركة المخزون، وبعدها نجمع الأرقام. مش العكس.',
    'ab.egEy': 'شغل الصيدليات في مصر',
    'ab.egT': 'القرص والشريط والعلبة مش مجرد ثلاث أسعار',
    'ab.egS': 'كل وحدة مرتبطة بكمية وسعر ورصيد. ضيف على ده شركات التأمين، عُهدة الدرج، فواتير الموردين، والعمل بالعربي. التفاصيل دي بتأثر في تصميم قاعدة البيانات والشاشات، مش بس في أسماء الحقول.',
    ...
    'ab.co1t': 'لما تحتاج تسأل',
    'ab.co1d': 'البريد العام وبريد الدعم:',
    'ab.co2t': 'الإعداد والتدريب',
    'ab.co2d': 'بنساعد في تجهيز الحساب، نقل البيانات المتفق عليها، وتدريب الفريق على البيع والجرد وإقفال الوردية.',
    'ab.co3t': 'المتاح واللي لسه بيتجهز',
    'ab.co3d': 'بنوضح الفرق بين الجزء اللي تقدر تستخدمه والجزء اللي لسه تحت التطوير. الإيصال الإلكتروني، مثلاً، ما زال قيد التجهيز.',
    'ab.ctaT': 'ورّينا طريقة شغلك، ونشرح لك Pharmora عليها',
    ...
    'pd.exp.l3': 'اختيار التشغيلة المناسبة تلقائياً عند كل عملية بيع',
    ...
    'pd.perm.l4': 'تتبع أي تعديل على رصيد المخزون',
  ...
  en: {
    ...
    'pr.compare': 'Quick guide:',
    'pr.inc1': 'System updates and improvements are included in the subscription',
    'pr.inc2': 'Support via WhatsApp and support@pharmora.com',

    'pr.guideTitle': 'Basic covers sales and inventory. Professional adds insurance and shifts. Multi-branch is for two or more locations.',
    'pr.guide1': 'Single-pharmacy pricing: EGP 800 or EGP 1,500 per month',
    'pr.guide2': 'Multi-branch pricing depends on branch count and operating setup',
    'pr.guide3': 'Every edition includes account setup, migration assistance, and team training',
    'pr.guideHint': 'If your operation sits between editions, we can work through it during the demo.',
    ...
    'ab.whyT': 'The problem was not a lack of software',
    'ab.whyS': 'The parts did not talk to each other. Purchase invoices landed in one place, inventory counts lived in a spreadsheet, and claims were reconciled in Excel at month-end. Owners had to check the same figures repeatedly just to understand stock or profit.',
    'ab.c1t': 'Sales and stock drift apart',
    'ab.c1d': 'If a sale does not reduce the right batch, the system balance and shelf count diverge. The discrepancy often appears during the next inventory count.',
    'ab.c2t': 'Revenue leaves out the hard part',
    'ab.c2d': 'A sales total says nothing about product cost, operating expenses, or the insurer share still to be collected. Those details determine the margin.',
    'ab.c3t': 'One product can have several expiry dates',
    'ab.c3d': 'The same medicine may be held across multiple batches. Quantity and expiry need to stay attached when stock is received and sold.',
    'ab.c4t': 'Coverage changes by medicine',
    'ab.c4d': 'An insurer may cover one medicine differently from another. The patient share and insurer share need to be calculated before the claim moves forward.',
    'ab.c5t': 'Access should match the job',
    'ab.c5d': 'Cashiers sell and close shifts. Price or stock changes require separate permission, and the audit log records who made them.',
    'ab.c6t': 'Pharmora connects those records',
    'ab.c6d': 'The sales invoice reduces the batch, records payment, and calculates insurance. Inventory and reports pick up the same transaction without another round of entry.',
    'ab.misEy': 'What we are working on',
    'ab.misT': 'Less manual checking, with the detail still available',
    'ab.misD': 'An owner should be able to open a stock or sales figure and get back to the transactions behind it. We treat the source of a number as part of the number.',
    'ab.visEy': 'What comes next',
    'ab.visT': 'Start with the operating details Egyptian pharmacies already have',
    'ab.visD': 'Right now, that means sales, inventory, insurance, suppliers, shifts, and daily financial records. For multiple branches, the same pricing, permission, and reporting rules need to hold from one location to the next.',
    'ab.philEy': 'Product decisions',
    'ab.philT': 'Every screen starts with an operating question',
    'ab.philS': 'Is the medicine in stock? Which batch should be sold? Who changed the price? Has the claim been collected? We start with the question, then build the screen.',
    'ab.p1t': 'Unit math',
    'ab.p1d': 'A tablet price must reconcile to its strip and box. Cost stays tied to the batch that was sold.',
    'ab.p2t': 'Role-specific screens',
    'ab.p2d': 'The cashier needs search, sale, and payment. Pricing rules and permission settings stay out of that workflow.',
    'ab.p3t': 'Recorded changes',
    'ab.p3d': 'Sensitive edits keep the user, time, and affected invoice, price, or stock balance in the audit log.',
    'ab.p4t': 'Shift close',
    'ab.p4d': 'Drawer movement, payment methods, and expenses need to be clear when a shift is handed over, not reconstructed at month-end.',
    'ab.p5t': 'Reports',
    'ab.p5d': 'We start with invoices and stock movements, then aggregate them. Not the other way around.',
    'ab.egEy': 'Egyptian pharmacy operations',
    'ab.egT': 'Tablet, strip, and box are not just three prices',
    'ab.egS': 'Each unit changes quantity, price, and stock differently. Add Arabic workflows, insurer rules, drawer accountability, and supplier balances. Those details shape the data model and the screens, not just the field labels.',
    ...
    'ab.co1t': 'When you need an answer',
    'ab.co1d': 'General and support email:',
    'ab.co2t': 'Account setup and training',
    'ab.co2d': 'We help configure the account, migrate the agreed data, and train the team on sales, inventory counts, and shift close.',
    'ab.co3t': 'Available versus in development',
    'ab.co3d': 'We label what can be used now and what is still being prepared. Electronic receipts, for example, remain in development.',
    'ab.ctaT': 'Show us how your pharmacy operates. We will walk through Pharmora in that context.',
