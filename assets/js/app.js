...
const I18N = {
  ar: {
    ...
    'pr.eyebrow': 'الأسعار',
    'pr.title': 'تسعير واضح — تثبيت السعر ١٢ شهراً عند التعاقد',
    'pr.sub': 'الأسعار المعروضة (٨٠٠ / ١٥٠٠ ج.م) تُثبَّت لمدة ١٢ شهراً لعملاء التأسيس عند التعاقد. من غير أجهزة خاصة ولا رسوم مخفية. اختَر الخطة حسب حجم شغلك، واحجز ديمو للتأكيد.',
    'pr.p1': 'الأساسية',
    'pr.p2': 'الاحترافية',
    'pr.p3': 'الفروع',
    ...
    'pr.note': 'الأسعار الحالية تُثبَّت ١٢ شهراً لعملاء التأسيس عند التعاقد — يُؤكَّد أثناء الديمو.',
    ...
    'ct.planBasic': 'الأساسية — 800 ج.م / شهرياً',
    'ct.planPro': 'الاحترافية — 1500 ج.م / شهرياً',
  ...
  en: {
    ...
    'pr.eyebrow': 'Pricing',
    'pr.title': 'Clear pricing — price locked for 12 months at signup',
    'pr.sub': 'Listed prices (EGP 800 / 1,500) are locked for 12 months for founding customers at signup. No special hardware, no hidden fees. Pick the plan for your size, then book a demo to confirm.',
    'pr.p1': 'Basic',
    'pr.p2': 'Professional',
    'pr.p3': 'Multi-branch',
    ...
    'pr.note': 'Current listed prices are locked for 12 months for founding customers at signup — confirmed during the demo.',
    ...
    'ct.planBasic': 'Basic — EGP 800 / month',
    'ct.planPro': 'Professional — EGP 1,500 / month',
